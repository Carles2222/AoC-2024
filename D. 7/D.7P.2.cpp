...
namespace AdventOfCode.Puzzles._2024._07.Parte2;
...
public partial class Parte2 : ISolucionPuzzle
{
    ...
    private bool Resolver(ulong resultadoActual, int indiceActual, ulong esperado, ulong[] numeros)
    {
        ...
        if (Resolver(ulong.Parse(resultadoActual.ToString() + numeros[indiceActual + 1].ToString()), indiceActual + 1, esperado, numeros))
        {
            return true;
        }
